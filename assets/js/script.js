...
function deleteProduct(id){
    ...
    fetch("http://ec2-13-201-58-195.ap-south-1.compute.amazonaws.com:8000/products",{method:"DELETE",headers: {'Content-Type': 'application/json'},body: JSON.stringify(res)})
...
function initilize(){
    ...
    fetch("http://ec2-13-201-58-195.ap-south-1.compute.amazonaws.com:8000/products",{method:'GET'})
    .then(result=>result.json())
    .then((data)=>{
